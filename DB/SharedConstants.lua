...
C.PATCH_INTERFACE_VERSIONS = {
	THE_WAR_WITHIN = {
		LAUNCH = 110000,
		TWENTIETH_ANNIVERSARY_CELEBRATION = 110005,
		SIREN_ISLE = 110007,
		UNDERMINE = 110100,
		LEGACY_OF_ARATHOR = 110107,
		GHOSTS_OF_KARESH = 110200,
		LEGION_REMIX = 110205,
		THE_WARNING = 110207,
	},
	MIDNIGHT = {
		LAUNCH = 120001,
		LINGERING_SHADOWS = 120005,
		REVELATIONS = 120007,
		CURSE_OF_ULATEK = 120100,
	},
}
...
C.UIMAPIDS = {
	...
	SPIRES_OF_ASCENSION = 1692,
	DE_OTHER_SIDE = 1677,
	HALLS_OF_ATONEMENT = 1663,
	CASTLE_NATHRIA = 1735,
	KORTHIA = 1961,
	TAZAVESH_THE_VEILED_MARKET = 1989, -- TBD: 2441 (check ingame)?
	...
	VALDRAKKEN = 2112,
	ALGETHAR_ACADEMY = 2097,
	BRACKENHIDE_HOLLOW = 2096,
	...
	UNDERMINE = 2346,
	SIREN_ISLE = 2369,
	THE_FORGOTTEN_VAULT = 2375,
	LIBERATION_OF_UNDERMINE = 2407,
	OPERATION_FLOODGATE = 2387,
	KARESH = 2371,
	MANAFORGE_OMEGA = 2471,
	TAZAVESH_KARESH = 2472,
	HORRIFIC_REVISION_OF_STORMWIND = 2403,
	HORRIFIC_REVISION_OF_ORGRIMMAR = 2404,
	-- Midnight zones
	SILVERMOON_CITY_MIDNIGHT = 2393,
	EVERSONG_WOODS_MIDNIGHT = 2395,
	ZUL_AMAN_MIDNIGHT = 2437,
	VOIDSTORM = 2405,
	HARANDAR = 2413,
	SLAYERS_RISE = 2444,
	TORMENTS_RISE = 2507,
	MAGISTERS_TERRACE_MIDNIGHT = 2520,
	WINDRUNNER_SPIRE = 2492,
	BLINDING_VALE = 2500,
	VOIDSPIRE = 2529,
	DREAMRIFT = 2531,
	SPOREFALL = 2427,
	MARCH_ON_QUELDANAS = 2533,
	RITUAL_SITES_MIDNIGHT = 2594,
	COILED_ISLES = 2512,
	ALTAR_OF_FANGS_MIDNIGHT = 2588,
	VENOMOUS_ABYSS = 2606, -- 5 options here, revisit if broken
}
